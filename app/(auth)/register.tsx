    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            <YStack flex={1} backgroundColor="$content3" alignItems="center" justifyContent="center" padding="$4">
                <Card elevate size="$4" bordered padding="$6" width={450} maxWidth="90%" backgroundColor="$content1"
                    ...
                    <YStack gap="$5" alignItems="center">
                        ...
                        <YStack gap="$3" alignItems="center">
                            ...
                            <H1 fontSize={28} fontWeight="bold" color="$accent7"
                                fontFamily="$oswald">{t('auth.createAccount')}</H1>
                            ...
                            <YStack gap="$2">
                                <XStack alignItems="center" gap="$2">
                                    ...
                                    <Text fontSize={14} fontWeight="500"
                                          color="$accent7">{t('auth.confirmPassword')}</Text>
                                </XStack>
                                <XStack alignItems="center" width="100%" position="relative">
                                    <Input
                                        placeholder={t('auth.passwordPlaceholder')}
                                    ...
                                    <Button
                                        ...
                                        zIndex={1}
                                    >
                                        {showConfirmPassword ? <EyeOff size={16} color="$accent7"/> :
                                            <Eye size={16} color="$accent7"/>}
                                    </Button>
                                </XStack>
